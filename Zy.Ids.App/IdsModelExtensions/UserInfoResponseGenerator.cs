...
namespace Singnalr.DAL.IdentityExentions
{
    public class UserInfoResponseGenerator : IdentityServer4.ResponseHandling.UserInfoResponseGenerator
    {
        ...
        public UserInfoResponseGenerator(IProfileService profile, IResourceStore resourceStore,
            ILogger<IdentityServer4.ResponseHandling.UserInfoResponseGenerator> logger) : base(profile, resourceStore, logger)
        {
        }
